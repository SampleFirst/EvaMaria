...
from info import ADMINS, UPDATE_CHANNEL, SUPPORT_CHAT_ID, GROUP_LOGS, AUTH_CHANNEL, AUTH_GROUPS, CUSTOM_FILE_CAPTION, IMDB, IMDB_TEMPLATE, P_TTI_SHOW_OFF, SINGLE_BUTTON, SPELL_CHECK_REPLY
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('Good to see you!')
            else:
    ...
    if query.data.startswith("file"):
                    ...
                    file_send = await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                                ...
                                [
                                    InlineKeyboardButton("Update Channel", url=(DEALS_CHANNEL))
                                ], 
                            ]
                        )
                    )
                    file_rece = await query.message.reply_text(
        ...
        file_send = await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("🔥 Letest Deals 🔥", url=(DEALS_CHANNEL))
                    ], 
                ]
            )
        )
        ...
        await query.answer('Good to see you!')
